...
export enum BulletNoteActionTypes {
  ...
  SET_SEARCHING_TEXT = 'SET_SEARCHING_TEXT',
  SET_DUE_DATE_MODE = 'SET_DUE_DATE_MODE',
  SET_BULLET_NOTE_CONFIG = 'SET_BULLET_NOTE_CONFIG',

  TOGGLE_IS_SHOW_DATE_TAG_DIVIDER = 'TOGGLE_IS_SHOW_DATE_TAG_DIVIDER',
  TOGGLE_IS_SHOW_OVER_DUE_MESSAGES = 'TOGGLE_IS_SHOW_OVER_DUE_MESSAGES',
}
